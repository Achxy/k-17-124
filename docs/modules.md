...
For the paper-order route, use [the reading guide](reading-guide.md).
...
| [HalfspaceRelators](../Kourovka/Halfspaces/HalfspaceRelators.lean) | Every relator of the actual augmented Schreier presentation is confined to one of the two overlapping halfspaces. |
...
| [SchreierKernel](../Kourovka/Halfspaces/SchreierKernel.lean) | The augmented Schreier presentation is a presentation of the actual kernel inside the original ordinary presented group. |
...
The four adapted infrastructure modules retain their upstream provenance.

- [RelatorBasic](../Kourovka/Schreier/RelatorBasic.lean)
- [RelatorCongruence](../Kourovka/Schreier/RelatorCongruence.lean)
- [RelatorOperations](../Kourovka/Schreier/RelatorOperations.lean)
- [Rewriting](../Kourovka/Schreier/Rewriting.lean)
